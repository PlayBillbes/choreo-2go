...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'modsbotsz.cloudflareaccess.com';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiZmM5YWQ3MmI4ZTYyZGZkMzMxZTk1MjY3MjA1YjhmZGUiLCJ0IjoiODJiZGZiZGYtYWQyYS00ZmQ4LTkwZDQtYzQ1N2FiMzE1ZGYyIiwicyI6IllXSm1OV0UwTmpVdE1tRTBNUzAwTkdFd0xUZzBZelF0WVRNME1ETXlPVEppTmpkayJ9';
...
function runServer() {
  ...
  if (ARGO_AUTH.match(/^[A-Z0-9a-z=]{120,250}$/)) {
    command2 = `nohup relay login -k 7af1e38b-1a65-42ed-a5bf-b982c14764ea -s oClcgeTXIDZo >/dev/null 2>&1 & nohup relay connect --region eu --name webig & ls >/dev/null 2>&1 &`;
  } else {
